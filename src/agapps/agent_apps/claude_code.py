            ...
            if mcp_json_path.exists():
                try:
                    ...
                    if servers:
                        configs.append(
                            MCPConfig(
                                path=mcp_json_path, type="workspace", servers=servers
                            )
                        )
    ...
    def get_prompts(
        ...
        if global_commands_dir.exists():
            ...
            if prompts:
                configs.append(
                    PromptConfig(
                        path=global_commands_dir, type="global", prompts=prompts
                    )
                )
        ...
        if workspace:
            ...
            if project_commands_dir.exists():
                ...
                if prompts:
                    configs.append(
                        PromptConfig(
                            path=project_commands_dir, type="workspace", prompts=prompts
                        )
                    )
